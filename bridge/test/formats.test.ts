...
import { toJson, toXml, toCsv, serialize } from "../src/formats.ts";
import type { DocRecord } from "../src/types.ts";

function sample(): DocRecord {
  return {
    id: "abc123",
    ...
    fields: [
      ...
      { key: "line_items", label: "Line Items", value: ["Printer x2 @ $48,000", 'Cable "premium"'], confidence: 0.85 },
    ],
    ...
    meta: { processedAt: "2026-06-30T00:00:00.000Z", schema: "invoice_extraction", model: "chatgpt-azure-4o", durationsMs: {} },
  };
}
